...
def save_report_html(
    df, target, task, eda_logs, preprocessing_logs,
    ...
    table.dataframe {{background:white; border-radius:8px;}}
    </style>
    </head><body>
    <div class="report-title">🔮 AutoML Classification Report</div>
    ...
    <div class="report-section">
    <span class="report-sub">🚨 Top 5 Misclassifications</span>
